/*
 This client program will test the myInsertionSort() function with a variety
 different input arrays and will compare the time-cost of using the insertion
...
int main() {
   ...
   cout <<  "Time-cost using myInsertionSort() with 10000 element array:"
   << endl << endl;
   cout << fixed << setprecision(4);

   startClock = clock();
   myInsertionSort(orderedArray, ARRAY_SIZE);
   stopClock = clock();
   cout << "It took "
   ...
   startClock = clock();
   myInsertionSort(randomArray, ARRAY_SIZE);
   stopClock = clock();
   cout << "It took "
   << 1000 * static_cast<double>(stopClock - startClock)/CLOCKS_PER_SEC
   ...
   startClock = clock();
   myInsertionSort(reverseOrderedArray, ARRAY_SIZE);
   stopClock = clock();
   cout << "It took "
   << 1000 * static_cast<double>(stopClock - startClock)/CLOCKS_PER_SEC
   ...
   startClock = clock();
   myInsertionSort(uniformArray, ARRAY_SIZE);
   stopClock = clock();
   cout << "It took "
   << 1000 * static_cast<double>(stopClock - startClock)/CLOCKS_PER_SEC
   ...
   startClock = clock();
   myInsertionSort(nearlyOrderedArray, ARRAY_SIZE);
   stopClock = clock();
   cout << "It took "
   << 1000 * static_cast<double>(stopClock - startClock)/CLOCKS_PER_SEC
   ...
   startClock = clock();
   myInsertionSort(orderedWithDuplicateElements, ARRAY_SIZE);
   stopClock = clock();
   cout << "It took "
   << 1000 * static_cast<double>(stopClock - startClock)/CLOCKS_PER_SEC
